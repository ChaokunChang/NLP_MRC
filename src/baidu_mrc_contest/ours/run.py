...
def parse_args():
    ...
    parser.add_argument('--contrain',action='store_true',
                        help='continue to train the trained model')
    ...
    train_settings.add_argument('--base_bleu_4', type=float, default=0.365,
                                help='based bleu_4')
...
def contrain(args):
    ...
    logger.info('Training the model...')
    rc_model.contrain(brc_data, args.epochs, args.batch_size, save_dir=args.model_dir,
                   save_prefix=args.algo,
                   dropout_keep_prob=args.dropout_keep_prob,
                   base_bleu_4=args.base_bleu_4)
    logger.info('Done with model training!')
